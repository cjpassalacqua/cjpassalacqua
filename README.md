...
## What I'm Working On
- Building and securing AWS environments  
- Cloud logging, monitoring, and threat detection  
- IAM best practices and identity governance  
- Entry-level SOC, cloud security, and DevSecOps foundations  
- Practical hands-on projects that mirror real security ops

---

## Skills & Tools
**Cloud:** AWS IAM, S3, CloudTrail, CloudWatch, VPC, EC2  
**Security:** GuardDuty, Security Hub, IAM Access Analyzer  
**Analysis:** Linux, Bash, Python basics, SQL  
**Monitoring:** SIEM fundamentals (Splunk), AWS CLI  
**Compliance:** HIPAA awareness from healthcare background  
